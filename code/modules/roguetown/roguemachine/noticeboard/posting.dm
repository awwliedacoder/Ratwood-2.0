/// Economy 3 noticeboard posting datum + pool helpers. Ported from Azure-Peak as-is;
/// GLOB.noticeboard_notices / GLOB.noticeboard_listings are declared in
/// code/__DEFINES/noticeboard.dm alongside the tier defines this relies on.
...
/proc/noticeboard_add_posting(tier, title, body, poster_name, poster_title, mob/living/carbon/human/poster)
	...
	// ES: reset the "have I seen the newest posting" tracker so examine() flags it again.
